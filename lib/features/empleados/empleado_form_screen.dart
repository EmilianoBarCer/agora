...
class _EmpleadoFormScreenState extends State<EmpleadoFormScreen> {
  ...
  Future<void> _registrar() async {
    final codigo    = int.tryParse(_codigoController.text.trim());
    final nombre    = _nombreController.text.trim();
    final direccion = _direccionController.text.trim();
    final telefono  = _telefonoController.text.trim();
    final fecha     = _fechaController.text.trim();

    if (codigo == null || nombre.isEmpty || direccion.isEmpty ||
    ...
    try {
      ...
      await conn.query(
        'INSERT INTO empleado (codigo, nombre, direccion, telefono, sexo, fecha_nacimiento, turno) '
      ...
      setState(() {
        _isLoading = false;
        _exito = true;
        _mensaje = 'Empleado registrado correctamente.';
      });
      _limpiar();
    } catch (e) {
      setState(() {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _campo('Código', _codigoController,
                    hint: 'Ej. 123123', teclado: TextInputType.number),
                _campo('Nombre completo', _nombreController,
                    hint: 'Ej. Juan Perez'),
                _campo('Dirección', _direccionController,
                    hint: 'Ej. ciruelos 234'),
                _campo('Teléfono', _telefonoController,
                    hint: 'Ej. 3312345678',
                    teclado: TextInputType.phone),
                _campo('Fecha de nacimiento', _fechaController,
                    hint: 'YYYY-MM-DD'),
